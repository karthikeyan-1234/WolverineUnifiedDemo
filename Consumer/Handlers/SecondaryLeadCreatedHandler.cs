...
{
    public class SecondaryLeadCreatedHandler
    {
        private readonly ILogger<SecondaryLeadCreatedHandler> _logger;

        public SecondaryLeadCreatedHandler(ILogger<SecondaryLeadCreatedHandler> logger)
        {
            _logger = logger;
        }
